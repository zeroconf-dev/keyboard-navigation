	    ...
	    return class extends react_1 {
	        ...
	        render() {
	            return (react_3(NavigationContext.Consumer, null, tabRegistry => {
	                ...
	                return (react_3(Comp, Object.assign({}, this.props, this.state, { ref: this.setComponentRef }), this.props.children));
	            }));
	        }
	    };
	}
	...
	class App extends react_1 {
	    ...
	    render() {
	        ...
	        react_3("form", { onSubmit: this.preventDefault },
	            react_3(TabBoundary, { cycle: true, ref: this.setBoundaryRef },
