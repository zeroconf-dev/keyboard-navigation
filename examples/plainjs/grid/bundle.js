(function () {
	...
	*/
	...
	function findFieldCoordinates(fieldMap, focusKey, maxX, maxY) {
	 ...
	 */
	function createNavigationHandler(navigationMap, getTabRegistry, tabDirectionAxis = 'x') {
	    ...
	    return (focusKey, navigationKey, modifierKeys) => {
	...
	***************************************************************************** */
	...
	class Grid extends react_1 {
	    constructor(props) {
	        ...
	        this.state = {
	            navigationHandler: createNavigationHandler(props.navigationMap, this.tabRegistryRef, props.tabDirectionAxis),
	        };
	    }
	    componentWillReceiveProps(nextProps) {
	    ...
	    render() {
	        const props = filterPropKeys(this.props, this.filterPropKeys);
	        return (react_3(TabBoundary, Object.assign({}, props, { as: this.props.as, boundaryKey: this.props.focusKey, tabRegistryRef: this.tabRegistryRef }), this.props.children(this.state.navigationHandler)));
	    }
	}
	Grid.defaultProps = {
	    tabDirectionAxis: 'x',
	...
	const navigationMap = [['section1', 'section2'], ['section3', 'section4']];
	class App extends react_1 {
	    ...
	    render() {
	        return (react_3(TabBoundary, null,
	            react_3(Grid, { className: "grid", focusKey: "grid", navigationMap: navigationMap }, this.renderGrid)));
	    }
	}
